...
class ControladorVentas{
	...
	static public function ctrRangoFechasVentasAdeudos($fechaInicial, $fechaFinal){

		$tabla = "ventas";

		$respuesta = ModeloVentas::mdlRangoFechasVentasAdeudo($tabla, $fechaInicial, $fechaFinal);
